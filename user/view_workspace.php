...
<div class="content-wrapper kanban pb-5">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <a href="index?page=add_workspace" class="btn btn-primary">Buat Task Baru <i class="fas fa-plus"></i></a>
                </div>
                <div class="col-sm-6 d-none d-sm-block">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index?page=beranda">Home</a></li>
                        <li class="breadcrumb-item active mb-3">My Task</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content bg-danger">
                                        ...
                                        <div class="modal-body bg-light">
                                            <p>Anda Yakin Menghapus Task <b><?= $dataTodo['nm_goal']; ?></b>?</p>
                                        </div>
