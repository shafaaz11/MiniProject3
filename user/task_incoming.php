...
JOIN users ON workspace.id_user = users.id_user";
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            ...
                            Management Task <b> <?= $data['nm_goal']; ?></b>
                        </h3>
                    ...
                    <div class="card-body">
                        <div class="text-center mb-4">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-todo"><i class="fas fa-plus"></i> Tambah Sub-Task</button>
                        </div>
                        <!-- Koding Tambah Todo -->
                        <?php
                        ...
                        <div class="modal fade" id="add-todo">
                            <div class="modal-dialog">
                                <div class="modal-content bg-primary">
                                    <div class="modal-header" <h6 class="modal-title">Menambahkan Sub-Task</h6>
                                    ...
                                    <form action="" method="POST">
                                        <div class="modal-body bg-light">
                                            <div class="card-body">
                                                <h6>Menambahkan Sub-Task <b><?= $_GET['nm_goal']; ?></b></h6>
                                                <div class="form-group">
                                                    <label for="nm_todo">Nama Task</label>
                                                    <input type="text" class="form-control" id="nm_todo" name="nm_todo" placeholder="Masukkan Nama Task">
                                                </div>
                                                <!-- Date -->
                                                <div class="form-group">
                                        ...
                                        <div class="modal fade" id="edit-todo<?= $dataTodo2['id_todo']; ?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-orange">
                                                    <div class="modal-header" <h6 class="modal-title">Edit Sub-Task</h6>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <form method="GET" action="edit_todo.php">
                                                        <div class="modal-body bg-light">
                                                            <div class="card-body">
                                                                <h6>Mengedit Sub-Task <b><?= $dataTodo2['nm_goal']; ?></b></h6>
                                                                <input type="hidden" name="id_todo" value="<?= $dataTodo2['id_todo']; ?>">
                                                                <input type="hidden" name="id_goal" value="<?= $dataTodo2['id_goal']; ?>">
                                                                <div class="form-group">
                                                                    <label for="nm_todo">Nama Sub-Task</label>
                                                                    <input type="text" class="form-control" id="nm_todo" name="title" value="<?= $dataTodo2['title']; ?>" placeholder="Masukkan Nama Sub-Task">
                                                                </div>
                                                                <!-- Date -->
                                                                <div class="form-group">
                                                                    <label>Tanggal Deadline</label>
                                        ...
                                        <div class="modal fade" id="hapus-todo<?= $dataTodo2['id_todo']; ?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-danger">
                                                    ...
                                                    <div class="modal-body bg-light">
                                                        <p>Anda Yakin Menghapus Sub-Task <b><?= $dataTodo2['title']; ?></b>?</p>
                                                    </div>
                                                    <div class="modal-footer justify-content-between bg-light">
                                                        <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Close</button>
