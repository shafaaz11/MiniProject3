...
<nav class="main-header navbar navbar-expand navbar-purple navbar-dark">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="index?page=view_workspace" class="nav-link">Task</a>
        </li>
    </ul>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index" class="brand-link">
        <img src="../assets/dist/img/task.jpg" alt="Dabta Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">Management Task</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="form-inline mt-3 pb-3 d-flex">
            <div class="input-group" data-widget="sidebar-search">
                <input class="form-control form-control-sidebar" type="search" placeholder="Cari Task" aria-label="Search">
                <div class="input-group-append">
